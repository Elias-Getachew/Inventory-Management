        ...
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
                <div>
                    ...
                    <h1 class="mt-4 text-3xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-8xl">Your One-Stop Shop for Everything You Love!</h1>
                    <p class="mt-4 text-base text-black lg:mt-8 sm:text-xl">Discover More, Spend Less!</p>

                    <a href="{{ route('register') }}" title="" class="inline-flex items-center px-6 py-4 mt-8 font-semibold text-black transition-all duration-200 bg-yellow-300 rounded-full lg:mt-16 hover:bg-yellow-400 focus:bg-yellow-400" role="button">
                        Join for free
          ...
          @foreach ($products as $item)
            <div class="flex-shrink-0 w-full md:w-1/3 p-4">
              <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <img class="lg:h-48 md:h-36 w-full object-cover object-center" src="{{ asset('storage/' . $item->photo) }}" alt="blog">
                <div class="p-6">
