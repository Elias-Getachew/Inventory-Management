        ...
        <div class="px-4 mx-auto sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 lg:h-20">
                ...
                <div class="hidden ml-auto lg:flex lg:items-center lg:justify-center lg:space-x-10">
                    ...
                    <a href="{{route('cart')}}" class="text-red-500 m-0 p-0 ">{{ count((array) session('cart')) }}<svg class="w-6 h-6 text-blue-400 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  ...
  >
    ...
    ></path>
                ...
                <div>
                    ...
                    {{-- <img class="w-full" src="https://cdn.pixabay.com/animation/2023/02/22/08/36/08-36-10-678_512.gif" alt="" /> --}}
                    <img class="w-full" src="https://th.bing.com/th/id/R.99400b6481d40b2997bcfc96b1f83f84?rik=dmYSeVUOU4AcdA&pid=ImgRaw&r=0" alt="" />
...
<div class="flex items-center justify-between text-sm tracking-widest uppercase">
    ...
    {{-- <form action="{{ route('ecommerce.index') }}" method="GET" id="sortForm"> --}}
            <select name="sort"  id="sortProducts" onchange="document.getElementById('sortForm').submit();" class="font-medium text-gray-700 bg-transparent dark:text-gray-500 focus:outline-none">
        ...
        {{-- </form> --}}
             ...
             <div  id="productsContainer">
                @include('ecommerce.partials.products', ['products' => $products])
             </div>
            </div>
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
        <div class="h-56 w-full">
          <a href="#">
           {{-- <img class="object-cover w-full rounded-md h-72 xl:h-80" src="{{ asset('storage/'.$product->photo) }}" alt="{{ $product->name }}"> --}}
            ...
            <img class="mx-auto h-full dark:hidden" src="{{ asset('storage/'.$product->photo) }}" alt="{{ $product->name }}" />
        ...
        <div class="pt-6">
          ...
          <div class="mt-4 flex items-center justify-between gap-4">
            ...
            <a href="{{ route('add_to_cart', $product->id) }}" class="inline-flex items-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 bg-gradient-to-r from-fuchsia-600 to-blue-600 dark:focus:ring-primary-800" role="button">
